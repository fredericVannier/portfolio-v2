...
export class IcoSystem extends Component {
  render() {
    return (
      <div className="project-wrapper">
        <div className="project-container-left">
          <div className="title-wrap-2">
            <Fade up delay="500">
              <h1 className="big-title-2">icoSystem</h1>
            </Fade>
            <Fade left delay="500">
        ...
        <Fade down delay="400">
          <div className="project-container-right-icoSystem"></div>
        </Fade>
      </div>
    );
  }
